...
<body class="antialiased min-h-screen flex flex-col selection:bg-[#DCD3C3] selection:text-[#1C1B18]">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between py-2 sm:py-2.5 gap-2 sm:gap-4 sm:min-h-[4.5rem]">
                ...
                <div class="flex items-center justify-between min-w-0 flex-1">
                    <div class="min-w-0">
                        <div class="flex items-center gap-2 flex-wrap">
                            <h1 class="text-sm sm:text-xl md:text-2xl font-serif-tc font-black tracking-tight sm:tracking-wide text-[#1C1B18] leading-tight truncate">
                                宜蘭縣建案備查與實價登錄檢索
                            </h1>
                ...
                <div class="grid grid-cols-4 sm:flex sm:items-center gap-1 sm:gap-2 shrink-0 w-full sm:w-auto">
                    ...
                    <button id="tabUpdateBtn" onclick="switchView('update')" class="px-2 sm:px-4 py-1.5 sm:py-2.5 text-xs sm:text-sm font-semibold rounded-lg sm:rounded-xl text-[#38342D] hover:bg-[#EAE4D8] border border-[#DCD4C5] bg-[#FFFFFF] flex items-center justify-center gap-1 sm:gap-1.5 transition">
                        ...
                        <span class="px-1 py-0.2 rounded-full text-[9px] font-mono font-bold bg-[#FEF3C7] text-[#92400E] ml-0.5 border border-[#FDE68A]">NEW</span>
                    </button>
    ...
    <main class="fluid-container py-6 flex-1 w-full">
        ...
        <div id="updateView" class="hidden space-y-6">
            ...
            <div class="bg-gradient-to-r from-[#24211D] to-[#38342D] text-[#FAF8F5] p-5 sm:p-7 rounded-2xl sm:rounded-3xl shadow-sm border border-[#4A443A] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                    ...
                    <p class="text-xs sm:text-sm text-[#D6CEBF] mt-1 font-normal">
                        精選呈現近三個月十大熱銷指標案、最新核准備查 5 大建案與最新揭露 30 筆成交實價登錄明細
                    </p>
                </div>
                <div class="flex items-center gap-3 sm:gap-4 shrink-0 flex-wrap">
                    <div class="bg-[#FFFFFF]/10 backdrop-blur-xs px-3.5 py-2 rounded-xl border border-[#FFFFFF]/15 text-center">
                        <div class="text-[11px] text-[#C2BBAE]">熱銷榜建案</div>
                        <div class="text-lg font-mono font-bold text-[#FAF8F5]">10 案</div>
                    </div>
                    <div class="bg-[#FFFFFF]/10 backdrop-blur-xs px-3.5 py-2 rounded-xl border border-[#FFFFFF]/15 text-center">
                        <div class="text-[11px] text-[#C2BBAE]">最新備查建案</div>
                        <div class="text-lg font-mono font-bold text-[#FAF8F5]" id="updateNewProjectsCount">5 案</div>
                    </div>
                    <div class="bg-[#FFFFFF]/10 backdrop-blur-xs px-3.5 py-2 rounded-xl border border-[#FFFFFF]/15 text-center">
                        <div class="text-[11px] text-[#C2BBAE]">最新成交實登</div>
                        <div class="text-lg font-mono font-bold text-[#E5C392]" id="updateNewTxCount">30 筆</div>
                    </div>
                    <div class="bg-[#FFFFFF]/10 backdrop-blur-xs px-3.5 py-2 rounded-xl border border-[#FFFFFF]/15 text-center">
                        <div class="text-[11px] text-[#C2BBAE]">最高成交單價</div>
                        <div class="text-lg font-mono font-bold text-[#86EFAC]" id="updateMaxPrice">-- 萬/坪</div>
                    </div>
                </div>
            </div>

            <!-- SECTION 1: 宜蘭最新實價登錄 · 近期十大熱銷建案榜 (Top 10) -->
                ...
                <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
                    <div>
                        <h3 class="text-base sm:text-lg font-serif-tc font-black text-[#1C1B18] tracking-wide flex items-center gap-2">
                            ...
                            <span>一、宜蘭最新實價登錄 · 近期十大熱銷建案榜 (Top 10)</span>
                        </h3>
            ...
            <!-- SECTION 2: 最新預售屋申報備查建案登錄 (近期五案) -->
            <div class="bg-[#FFFFFF] p-5 sm:p-6 rounded-2xl sm:rounded-3xl border border-[#DCD4C5] shadow-xs">
                <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
                    <div>
                        <h3 class="text-base sm:text-lg font-serif-tc font-black text-[#1C1B18] tracking-wide flex items-center gap-2">
                            <span class="text-xl">🆕</span>
                            <span>二、最新預售屋申報備查建案登錄 (近期五案)</span>
                        </h3>
                        <p class="text-xs text-[#6E675B] mt-0.5 font-medium">
            ...
            <!-- SECTION 3: 本期最新成交實價登錄明細 (近期 30 筆) -->
            <div class="bg-[#FFFFFF] p-5 sm:p-6 rounded-2xl sm:rounded-3xl border border-[#DCD4C5] shadow-xs">
                <div class="flex items-center justify-between mb-4 flex-wrap gap-2">
                    <div>
                        <h3 class="text-base sm:text-lg font-serif-tc font-black text-[#1C1B18] tracking-wide flex items-center gap-2">
                            <span class="text-xl">📈</span>
                            <span>三、本期最新成交實價登錄明細 (近期 30 筆)</span>
                        </h3>
                        <p class="text-xs text-[#6E675B] mt-0.5 font-medium">
    ...
    <script>
        ...
        function renderWeeklyUpdateView() {
            ...
            if (countEl) countEl.innerText = recentTx.length + ' 筆';
            
            const maxPriceEl = document.getElementById('updateMaxPrice');
            if (maxPriceEl && recentTx.length > 0) {
                const maxP = Math.max(...recentTx.map(t => t.pricePerPing || 0).filter(p => p > 0));
        ...
        function exportCurrentViewToExcel() {
            ...
            try {
                ...
                if (currentView === 'update') {
                    ...
                    XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(top5), '近期五案最新備查');
                    ...
                    XLSX.utils.book_append_sheet(wb, XLSX.utils.json_to_sheet(allTx.slice(0, 30)), '近期30筆成交實登');

                    XLSX.writeFile(wb, '宜蘭建案_本期最新速報.xlsx');
